...
VARIABLE MAINX
TC-ALIGNMENT  CONSTANT DEFAULT-ALIGNMENT
...
: POOL-INIT ( n -- )
  ...
  TRUE WARNING !
  12 C-SMUDGE !
  DEFAULT-ALIGNMENT SET-ALIGNMENT
  INIT-MACROOPT-LIGHT
;
...
: UNSEAL-SCATTER  ( xt.scattered  -- sys.scattered )  >BODY DUP @  1 >RESOLVE ENTER-COMPILATION ;
: RESEAL-SCATTER  ( sys.scattered --               )  DUP CELL+ BRANCH, >MARK SWAP ! LEAVE-COMPILATION ;
