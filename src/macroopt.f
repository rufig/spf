\ Îïòèìèçèðóþùèé ìàêðîïîäñòàíîâøèê        Ìàêñèìîâ Ì.Î.
...
\ $ - ºúð÷vòðõª ýð ¯¨ðóüõýª ø¸¿þôýþóþ ªõú¸ªð, þÿªøüø÷ø¨ºõüvù
\ ôðýývü üõªþôþü
...
M\ PPPP
    ...
    OP1 @  @ FFFFFF AND 85048D XOR OR  \  LEA     EAX , Y [EAX*X] ãðóáî
    OP0 @ W@ 4503   XOR  OR
    OP2 @  2+ C@ OP0 @  2+  C@ XOR OR 0= \   X2=X0
    IF M\ 318 DTST
...
(  ['] DROP
  0xC00B W,    \ OR EAX, EAX
  OPT?  IF -2 ALLOT   \ v°·ª°¯¨á°à OR EAX, EAX
