...
ALSO CONSTS CONTEXT ! DEFINITIONS
  ...
  WM_USER  1 + CONSTANT SB_SETTEXTA
  WM_USER 11 + CONSTANT SB_SETTEXTW
  WM_USER  9 + CONSTANT SB_SIMPLE
  255 CONSTANT SB_SIMPLEID
  256 CONSTANT SBT_NOBORDERS
...
CREATE sTypeFlush	S" TypeFlush" HERE SWAP DUP ALLOT MOVE 0 C,
CREATE sViewSB	S" ViewSB" HERE SWAP DUP ALLOT MOVE 0 C,
CREATE sViewTB	S" ViewTB" HERE SWAP DUP ALLOT MOVE 0 C,
