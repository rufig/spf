...
\ Например операции 2DROP 2DROP 2DROP соответсвует комбинация 7.
...
\ Перед самим композицией нужно сперва привести глубины
\ комбинаций:
\ SWAP 2SWAP --> 12 2143
...
OVER DUP @  OVER CELL+ DUP @ 2SWAP SWAP ROT SWAP ! SWAP ! \ Хак!.. Меняем значение первого и второго элемента в цикле.
