...
\ однобайтных символов но и, с допустим, с текстом в UTF-8... Э, а iterateByBytes ?.!. Хм...
\ Облом... Надо подумать.
...
p @  e @ OVER - \ обработаем и последний отрезок, не кончающийся на char
?DUP IF CONT 2DROP ELSE DROP THEN \ если он есть
;
