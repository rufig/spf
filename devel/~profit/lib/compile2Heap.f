...
\ Осторожно, так как компиляция проходит в один приём, команда
\ VC- может прозевать выход за границы куска...
\ Поэтому особенно много (в байтах выходной последовательности
\ маш. кодов) не компилируйте.
;MODULE
