...
3 выполняет: lit ; 
\ 4 - >R 
4 выполняет: RStF FALSE! RPUSH DPOP RADF FALSE! >RAD nop ; 
\ 5 - R> 
5 выполняет: RPOP DPUSH RADF TRUE! >RAD nop ; 
\ 6 - ret 
6 выполняет:  ret ; 
\ 7 - dup 
7 выполняет: DPUSH >RAD nop ; 
\ 8 - drop 
8 выполняет: DPOP >RAD nop ; 
\ 9 - over 
9 выполняет: DPOP DSWAP >RAD DPUSH DSWAP >RAD nop ; 
\ A - swap 
A выполняет: DSWAP >RAD nop ; 
\ B - pre: 
B выполняет: nop ; 
\ C - user: 
C выполняет: nop ; 
