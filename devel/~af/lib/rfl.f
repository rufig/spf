...
0 VALUE RFLBefore \ где вставл€ть список в меню
0 VALUE hRFLMenu \ меню содержащее список

VOCABULARY RFLSupport
GET-CURRENT ALSO RFLSupport DEFINITIONS

0 VALUE RFList \ лист, хран€щий имена файлов. 9 €чеек, 0-ва€ €чейка - голова
0 VALUE inifile  \ им€ файла, в котором хранитс€ список
0 VALUE rflsection \ им€ секции rfl
...
\ скопировать строку в хип программы и вернуть еЄ адрес в хипе
  0 MAX
