\ $Id$
\ 
\ –аспознавание вещественных чисел
\ - „исла вида 12.34e - на float стек (lib/include/float2.f)
\ - „исла вида 12.34f - на стек данных (в вещественном IEEE формате 4 байта)
\ - „исла вида 12.34d - на стек данных (в вещественном IEEE формате 8 байт) - двойное значение
...
: AUTO-FLOAT-LITERAL { a u | s -- a u FALSE | TRUE }
  ...
  \2 S" f" COMPARE-U 0 = IF
   FLOAT>DATA32 [COMPILE] LITERAL
  ELSE
   FLOAT>DATA SWAP [COMPILE] 2LITERAL
  THEN
  TRUE ;
