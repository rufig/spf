...
\ в частности квакает если a1 = a2
 ...
 3. К этим именам слов :
  - стековая нотация (должна быть на той же строке что и имя слова)
...
1. Если дока генерится автоматом каждый раз - не дописывалось ничего вручную
   - добавить строчки в zall.bat (смотреть по шаблону)
