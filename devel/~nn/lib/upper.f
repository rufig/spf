DECIMAL
CREATE upp-buf  0 C,  1 C,  2 C,  3 C,  4 C,  5 C,  6 C,  7 C,  8 C,  9 C,
               ...
               180 C, 181 C, 182 C, 183 C, 168 C, 185 C, 186 C, 187 C, 188 C, 189 C,
               190 C, 191 C,
               C" абцдефгхийклмнопярстужвьызшэщчъюабцдефгхийклмнопярстужвьызшэщчъ" ", \ "
               CHAR ю upp-buf CHAR ю + C!

: xUPPER-CHAR ( c1 -- c2 ) upp-buf + C@ ;
: xUPPER ( a u - ) OVER + SWAP ?DO I C@ xUPPER-CHAR I C! LOOP ;

WINAPI: CharUpperBuffA USER32.DLL
WINAPI: CharUpperA USER32.DLL
: apiUPPER-CHAR ( c1 -- c2 ) CharUpperA ;
: apiUPPER ( a u --) SWAP CharUpperBuffA DROP ;

VECT UPPER-CHAR ' xUPPER-CHAR TO UPPER-CHAR
VECT UPPER      ' xUPPER TO UPPER
