\ то же, что и xml.f, но CAR/CDR берут и текстовые узлы, атрибуты и т.д.

( ~ac 20.08.2005
  $Id: xml.f,v 1.5 2005/09/26 19:38:52 spf Exp $
