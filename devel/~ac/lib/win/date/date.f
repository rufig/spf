...
CREATE ƒней¬ћес€це1 31 C, 28 C, 31 C,  30 C, 31 C, 30 C,  31 C, 31 C, 30 C,  31 C, 30 C, 31 C,
USER-CREATE ƒней¬ћес€це2 12 USER-ALLOT

: ƒней¬ћес€це
  ƒней¬ћес€це2 C@ 31 <> IF ƒней¬ћес€це1 ƒней¬ћес€це2 12 MOVE THEN
  ƒней¬ћес€це2
;
: ƒнейƒоЌачалаћес€ца
...
: ?¬исокосный
  4 MOD 0=
;
: Ќомерƒн€¬√оду ( день мес€ц год -- число )
  ?¬исокосный IF 29 ELSE 28 THEN ƒней¬ћес€це 1+ C!
  ƒнейƒоЌачалаћес€ца +
;
