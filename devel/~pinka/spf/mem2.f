...
( Расширение SPF4
  изменяет поведение слов ALLOCATE FREE RESIZE
...
\  на совести вызывающей программы: либо создавать такой хип
\  с соответствующим флагом, либо использовать объекты взаимного
\  исключения (критические секции, мутексы, и т.п.).
\ Доступ к хипу процесса заведомо синхронизируется в силу его атрибутов,
\  независимо от флага синхронизации в HeapAlloc & Co.
