...
\ Описание устройств, структур и масок

 Этот файл сохранился со времен СМАЛ32 и справедлив для библиотечки на СПФ
------------------------------------------------------------------------------
...
Все определенные до Unit; слова окажутся в этом словаре.
...
Эти слова позволяют управлять словарями, то есть делать нужное кол-во
