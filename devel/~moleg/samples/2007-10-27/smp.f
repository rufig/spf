...
\ найти в верхнем контекстном словаре все похожие слова
\ то есть для каждого слова в словаре найти все слова, находящиеся в этом
\ же словаре, отличающиеся от последнего в одной символьной позиции.
: alll ( --> )
       CONTEXT @ @ >R
       BEGIN R@ WHILE
             CR R@ COUNT similar
