...
\ CR .( FSL-UTILG.FTH    $Revision$       $Date$   EFC )
\       fsl-utilg.fth    V1.18    corrected } and }}    Nov 2004   cgm
\       fsl-utilg.fth    V1.19    added }}fcopy         Apr 2005   cgm
...
: }}fcopy ( 'src 'dest n m  -- )    \ copy nXm elements of 2-D fp array src to dest
        SWAP 0 DO
                 DUP 0 DO
                            2 PICK J I  }} F@
                            OVER J I }} F!
