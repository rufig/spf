...
Внимание: эта библиотека не оказывает влияния на слова `[IF] ... [ELSE] ... [THEN]`.
Поэтому если в вашем исходном файле они используются, и вы хотите запустить
его на SPF - то найдите и переведите все варианты написания `[THEN]` (`[Then]`, `[then]`
 и т.д.) в верхний регистр.
...
----
<a id="float"/>
###[Вещественные числа (числа с плавающей точкой)][start]
